...
<html lang="pt">
  <head>
    ...
    <title>CSNSA - Painel de gestão</title>
    <!-- Simple bar CSS -->
    ...
    <div class="wrapper vh-100">
      <div class="align-items-center h-100 d-flex w-50 mx-auto">
        <div class="mx-auto text-center">
          ...
          <h1 class="mb-1 text-muted font-weight-bold">Ups!</h1>
          <h6 class="mb-3 text-muted">A página não foi encontrada.</h6>
          <a href="index.php?csnsa=inicio" class="btn btn-lg btn-primary px-5">Voltar ao painel</a>
        </div>
      </div>
    </div>
